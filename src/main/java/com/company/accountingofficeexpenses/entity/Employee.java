...
@Table(name = "EMPLOYEE", indexes = {
        @Index(name = "IDX_EMPLOYEE", columnList = "SUBDIV_EMPLOYEE_ID")
})
@Entity
public class Employee {
    ...
    @Composition
    @OneToMany(mappedBy = "employeeExpense")
    private List<Expense> expenseEmployee;

    @JoinColumn(name = "SUBDIV_EMPLOYEE_ID", nullable = false)
